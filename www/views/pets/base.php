                ...
                <nav class="navbar navbar-default" role="navigation">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="<?php echo '/services.php' == $container ? 'active' : '' ?> col-xs-6 col-md-2 col-md-offset-1"><a href="services">Services</a></li>
                            ...
                            <li class="<?php echo '/adoption.php'  == $container ? 'active' : '' ?> col-xs-6 col-md-2 "><a href="adoption">Adoption</a></li>
